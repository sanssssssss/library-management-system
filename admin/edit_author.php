		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="No_Of_Books" value="<?php echo $No_Of_Books;?>" class="form-control" required="">
				</div>
				<div class="form-group">
					<label>Origin:</label>
				...
				<script>
				function showAlert() {
    alert("Author edited. Please make a Refresh...");
  }
  </script>
				<button class="btn btn-primary" name="update" onClick="showAlert()">Update Author</button>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "update authors set author_name='$_POST[author_name]',No_Of_Books=$_POST[No_Of_Books], Origin='$_POST[Origin]', Gender='$_POST[Gender]' where author_id = $_GET[aid]";
		$query_run = mysqli_query($connection,$query);
	}
?>